    ...
    <div className="min-h-screen p-4 pt-8 md:p-8 md:pt-12">
      <div className="max-w-7xl w-full mx-auto relative">
        <a 
          ...
          className="absolute top-0 right-0 p-2 text-white hover:text-[#f4a259] transition-colors"
        >
        ...
        <header className="mb-6 md:mb-8 text-center border-b border-white pb-4 md:pb-6">
          <h1 className="text-4xl md:text-6xl font-bold text-white">NYT Connections <span className="text-[#f4a259]">AI</span></h1>
        </header>
