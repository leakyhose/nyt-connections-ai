  ...
  return (
    <div className="min-h-screen bg-white px-4 py-6">
      <div className="max-w-game w-full mx-auto">
        ...
        <div className="text-center text-sm mt-4 mb-4 font-semibold text-gray-400">
          {isAutoPlaying ? (
            <span className="inline-flex items-center gap-1.5 text-black">
              AI is playing
              <svg className="gear-spin" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        ...
        {/* One Away message — space always reserved */}
        <div className="mt-2 mb-1 text-center leading-5">
          <span className={`text-xs font-semibold transition-opacity duration-200 ${
            statusText === 'ONE AWAY!' ? 'text-black opacity-100' : 'opacity-0'
          }`}>
            ONE AWAY!
          </span>
        </div>
        ...
        {/* Footer */}
        <footer className="mt-8 pt-4 border-t border-gray-200 flex items-center justify-center gap-1.5 text-xs text-gray-400">
          By: Yiming Su
